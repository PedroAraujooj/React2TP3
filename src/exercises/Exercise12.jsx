...
import {alterarUsuarioTP3, inserirUsuariosTP3, listarUsuariosTP3, obterUsuarioTP3} from "../infra/usuarioTP3.jsx";
    ...
    return (
        <div>
            ...
            <form>
                ...
                />
                <br/>
                <button type={"button"} onClick={handleSubmit(handleClick)}>{idEmEdicao? "ALTERAR":"INSERIR"}</button>
            </form>
